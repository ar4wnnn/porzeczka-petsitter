        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              >
                Nasze Usługi <span className="text-sky-dark">Dla Pupili</span> 🐾
              </motion.h1>
              <motion.p 
              ...
              <div className="mb-12">
                ...
                <div className="flex flex-col items-center justify-center mb-8">
                  <button 
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-[#FF6B9E] to-[#B86EFF] text-white rounded-full text-lg font-medium shadow-lg hover:shadow-xl transition-all transform hover:scale-105 focus:outline-none flex items-center gap-2"
                  >
                          ...
                          >
                            <div className="p-6 border-t border-gray-100">
                              ...
                              <div className="mt-6">
                                <Link 
                                  href="/book"
                                  className="block w-full py-3 bg-gradient-to-r from-[#FF6B9E] to-[#B86EFF] text-white rounded-lg font-medium shadow-md hover:shadow-lg transition-all text-center"
                                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center mb-16">
              <motion.h2 
                ...
                viewport={{ once: true }}
              >
                Opieka nad Zwierzętami <span className="text-sky-dark">Egzotycznymi</span> 🦜
              </motion.h2>
              <motion.p 
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 mb-16">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                ...
                >
                  <Link 
                    href="/book" 
                    className="px-8 py-3 bg-gradient-to-r from-[#FF6B9E] to-[#B86EFF] text-white rounded-full font-bold hover:shadow-lg transition-all inline-flex items-center"
                  >
